                        ...
                        tapAction: { [weak environment] attributes, _ in
                            if let url = attributes[NSAttributedString.Key(rawValue: TelegramTextAttributes.URL)] as? String,
                                ...
                                if url.hasPrefix("https://apps.apple.com/account/subscriptions") {
                                    ...
                                    controller.context.sharedContext.openExternalUrl(context: controller.context, urlContext: .generic, url: url, forceExternal: !url.hasPrefix("tg2://"), presentationData: controller.context.sharedContext.currentPresentationData.with({$0}), navigationController: nil, dismissInput: {})
                                } else {
